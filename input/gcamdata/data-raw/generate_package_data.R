...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["PerCapitaBased"]] <- c("region", "energy.final.demand", "perCapitaBased")
  ...
  level2_data_names[["PerCapitaBased_trn"]] <- c("region", "gcam.consumer", "perCapitaBased")
  level2_data_names[["PriceElasticity_trn"]] <- c("region", "gcam.consumer", "year", "price.elasticity")
  level2_data_names[["IncomeElasticity_trn"]] <- c("region", "gcam.consumer", "year", "income.elasticity")
  level2_data_names[["BaseService_trn"]] <- c("region", "gcam.consumer", "year", "base.service")
  ...
  level2_data_names[["DemandFunction_trn"]] <- c("region", "gcam.consumer", "prodDmdFnType")
