...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["SubregionalShares_trn"]] <- c("region", "energy.final.demand", "pop.year.fillout", "inc.year.fillout", "subregional.population.share", "subregional.income.share")
  ...
  level2_data_names[["DemandFunction_trn_coef"]] <- c("region", "energy.final.demand", "coef_trn")
  level2_data_names[["CalPrice_trn"]] <- c("region", "energy.final.demand","basePrice")
